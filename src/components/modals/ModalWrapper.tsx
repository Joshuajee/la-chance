...
const ModalWrapper = (props: IProps) => {
    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-screen text-gray-600" style={{zIndex: 10, position: "fixed" }}>
            ...
            <div className="fixed flex justify-center items-center h-screen w-screen">
                ...
                <div className="bg-white mx-4 rounded-lg w-full max-w-[500px] min-h-[150px]">
